...
export const FoodLoggingModal: React.FC = () => {
  ...
  const { servingSize, servingUnit, notes, selectedMealTime } = useSelector(
    (state: RootState) => selectLoggingState(state)
  );
  ...
  const availableMeasures = selectedFood.measures || [
    { label: "serving", weight: 100, uri: "" },
  ];
        ...
        <VStack className="flex-1">
          ...
          <View style={styles.section}>
            ...
            >
              <Text style={styles.mealTimeText}>
                {MEAL_TIME_CONFIGS[selectedMealTime as MealTime].icon}{" "}
                {MEAL_TIME_CONFIGS[selectedMealTime as MealTime].label}
              </Text>
            ...
            <HStack className="items-center justify-between">
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  const currentIndex = availableMeasures.findIndex(
                    (m: any) => m.label === servingUnit
                  );
                  const nextIndex =
                    (currentIndex + 1) % availableMeasures.length;
          ...
          <View style={styles.section}>
            ...
            <View style={styles.nutritionGrid}>
              ...
              <View style={styles.nutritionItem}>
                <Text style={styles.nutritionValue}>
                  {calculateNutrition(selectedFood.protein)}g
                </Text>
                <Text style={styles.nutritionLabel}>Protein</Text>
              </View>
              <View style={styles.nutritionItem}>
                <Text style={styles.nutritionValue}>
                  {calculateNutrition(selectedFood.carbs)}g
                </Text>
                <Text style={styles.nutritionLabel}>Carbs</Text>
              </View>
              <View style={styles.nutritionItem}>
                <Text style={styles.nutritionValue}>
                  {calculateNutrition(selectedFood.fat)}g
                </Text>
            ...
            <View style={styles.pickerContainer}>
              ...
              {Object.values(MEAL_TIME_CONFIGS).map((config) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.pickerOption,
                    selectedMealTime === config.mealTime &&
                ...
                >
                  ...
                  <Text style={styles.pickerOptionTime}>
                    {config.timeRange}
                  </Text>
                </TouchableOpacity>
              ))}
